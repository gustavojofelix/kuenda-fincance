...
public class GetPAR30Request
{
    public Guid? BranchId { get; set; }
}

public class GetPAR30Endpoint : Endpoint<GetPAR30Request, List<Par30ItemDto>>
{
    private readonly IMediator _mediator;

    public GetPAR30Endpoint(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        Get("/api/reports/par30");
        Claims("tenantId");
    }

    public override async Task HandleAsync(GetPAR30Request req, CancellationToken ct)
    {
        ...
        var query = new GetPAR30Query(tenantId, branchId);
