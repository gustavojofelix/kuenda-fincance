...
public class GetMAP14Endpoint : Endpoint<GetMAP14Request, List<Map14ItemDto>>
{
    private readonly IMediator _mediator;

    public GetMAP14Endpoint(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        Get("/api/reports/map14");
        Claims("tenantId");
    }

    public override async Task HandleAsync(GetMAP14Request req, CancellationToken ct)
    {
        ...
        var query = new GetMAP14Query(tenantId, branchId, start, end);
