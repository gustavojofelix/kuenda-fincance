...
public class GetDashboardMetricsEndpoint : Endpoint<GetDashboardMetricsRequest, DashboardMetricsDto>
{
    private readonly IMediator _mediator;

    public GetDashboardMetricsEndpoint(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    public override async Task HandleAsync(GetDashboardMetricsRequest req, CancellationToken ct)
    {
        ...
        var query = new GetDashboardMetricsQuery(tenantId, branchId);
