...
public class GetMAP10Endpoint : Endpoint<GetMAP10Request, List<Map10ItemDto>>
{
    private readonly IMediator _mediator;

    public GetMAP10Endpoint(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        Get("/api/reports/map10");
        Claims("tenantId");
    }

    public override async Task HandleAsync(GetMAP10Request req, CancellationToken ct)
    {
        ...
        var query = new GetMAP10Query(tenantId, branchId, start, end);
