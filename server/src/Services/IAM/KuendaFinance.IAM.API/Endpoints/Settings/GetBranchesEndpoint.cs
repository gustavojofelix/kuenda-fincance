...
public class GetBranchesEndpoint : EndpointWithoutRequest<List<BranchDto>>
{
    private readonly IMediator _mediator;

    public GetBranchesEndpoint(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        var query = new GetBranchesQuery(tenantId);
