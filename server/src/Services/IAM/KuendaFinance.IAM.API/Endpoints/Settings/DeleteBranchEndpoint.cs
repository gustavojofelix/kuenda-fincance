...
public class DeleteBranchEndpoint : EndpointWithoutRequest
{
    private readonly IMediator _mediator;

    public DeleteBranchEndpoint(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        var command = new DeleteBranchCommand(idRoute, tenantId);
